...
export default function CardProduct(second) {
    return (
        <div className="flex flex-col w-full overflow-hidden bg-white rounded-lg shadow-lg">
            ...
            <div className="w-full p-5">
                ...
                <SecondButton href={route('productDetail','sernafil-event')} className="w-full text-xs hover:bg-blue-700 focus:bg-blue-700 active:bg-blue-700 hover:text-white focus:text-white active:text-white">Selengkapnya</SecondButton>
            </div>
        </div>
    )
}